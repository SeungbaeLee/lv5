...
public class BucketController {
    ...
    @GetMapping
    public ResponseEntity<BucketResponseDto> readBucket(@PathVariable("memberId") @Positive long memberId) {
        BucketResponseDto bucketResponseDto = bucketService.readBucket(memberId);
        return new ResponseEntity<BucketResponseDto>(bucketResponseDto, HttpStatus.OK);
    }

    @PatchMapping("/{productId}")
    public ResponseEntity<BucketResponseDto> updateQuantity(@PathVariable("memberId") @Positive long memberId,
